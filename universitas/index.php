  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="index2.php">Data Obat</a>
        </li>  
      </ul>
...
<h1 h1 style="text-align:center">Tabel Mahasiswa</h1>
<div class="container">
<a href="mahasiswa_formadd.php" type="button" class="btn btn-primary">Add </a>
<table class="table">
  <thead>
  <tr>
      <th scope="col">NO</th>
  ...
  <?php 
										$nomor = 0;
										$sqlmahasiswa = "SELECT * FROM mahasiswa ORDER BY mahasiswa.nama ASC";
										$querymahasiswa = mysqli_query($koneksidb,$sqlmahasiswa);
										while ($result = mysqli_fetch_array($querymahasiswa)){
											$nomor++;
											?>
										<tr>
											...
											<td><?php echo htmlentities($result['no_tlp']);?></td>
											<td><?php echo htmlentities($result['prodi']);?></td>
                      <td class='text-left'>
                            <a class='btn btn-warning btn-sm' data-bs-toggle='modal' data-bs-target='#konfirmasi_update' data-href="mahasiswa_formedit.php?id=<?php echo $result['id'];?>"> Update </a>
                            <a class='btn btn-danger btn-sm' data-bs-toggle='modal' data-bs-target='#konfirmasi_hapus' data-href="mahasiswa_hapus.php?id=<?php echo $result['id'];?>">Delete</a>
                              ...
                              <div class="modal-dialog">
                                  <div class="modal-content">
                                      <div class="modal-body">
                                          <p>Apakah Anda yakin ingin mengubah data mahasiswa ini?</p>
                                      </div>
